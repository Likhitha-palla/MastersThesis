...
class UPFPGrowthPlus(_ab._periodicFrequentPatterns):
    ...
    def _removeFalsePositives(self):
        ...
        self.falsePatterns = len(self._periodic) - len(self._finalPatterns)
    ...
    def startMine(self):
        ...
        print("Periodic Frequent patterns were generated successfully using UPFPgrowth++ algorithm")
    ...
    def getFalsePatterns(self):
        """ Function to send the set of false patterns after completion of the mining process

        :return: returning false patterns
        :rtype: dict
        """
        return self.falsePatterns

    def printResults(self):
        print("Total number of  Uncertain Periodic-Frequent Patterns:", len(self.getPatterns()))
        print("Total number of generated false patterns:", self.falsePatterns)
